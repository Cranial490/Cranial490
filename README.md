...
- [RAG Pipeline](https://github.com/Cranial490/RAG_module) A configurable Retrieval-Augmented Generation pipeline built around plugin strategies.
- [BotanicAI Agent Builder -- *half baked*] (https://github.com/Cranial490/Botanicai) BotanicAI is a backend platform for building, running, and scaling AI agents.
---
